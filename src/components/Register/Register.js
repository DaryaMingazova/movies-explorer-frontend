  ...
  return (
    <Form header="Добро пожаловать!" submit="Зарегистрироваться" question="Уже зарегистрированы?" link="Войти" path="/signin">
      <label className="form__item">
        ...
        <input type="text" className="form__field" defaultValue="Дарья" placeholder="Введите имя" required minlength="2" maxlength="35"/>
      ...
      <label className="form__item">
        ...
        <input type="password" className="form__field form__field_color-error" defaultValue="••••••••••••••" placeholder="Введите пароль" required minlength="2" maxlength="35"/>
